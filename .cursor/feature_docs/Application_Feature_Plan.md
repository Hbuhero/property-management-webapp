...
- Add unit-specific `PropertyApplication`.
  ...
  - Fields: tenant, property, floorUnit, status, coverNote, rejectionReason, reviewedBy, reviewedAt, timestamps.
...
- Replace tenant `LeaseManagement.tsx` static data with real applications/contracts.
  - Sent contracts show terms, items, and required legal checkboxes.
